...
def resource_path(filename):
    ...
    except:import pygame, sys, os, random, json
from pygame.locals import *
pygame.init()
pygame.mixer.init()
...
def reset():
    global game_state, feedback, user_input, border, paused, player_imagex, player_imagey, collision, saving, loading, screen_objects
    game_state = "menu"
    feedback = ""
    user_input = ""
    paused = False
...
#8000 X 8000 pixels
city_map = {(0, 0, 200, 7600): "wall", (0, 7400, 7600, 200): "wall", (7400, 0, 200, 7600): "wall", (0, 0, 7600, 200): "wall", (500, 1200, 768, 768):"house", (700, 7000, 768, 768): "house", (800, 6400, 768, 768): "house", (6000, 5000, 768, 768): "house", (4000, 3700, 768, 768): "building", (6500, 400, 768, 768): "building", (300, 2500, 768, 768): "building"}
...
objects.set_colorkey(pygame.Color(255, 255, 255))
...
while running == True:
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if event.button == 1:
                if game_state == "menu":
                    ...
                    if paused == True and saving == False and loading == False:
                        if mouse_pos[0] < continue_button.right and mouse_pos[0] > continue_button.left and mouse_pos[1] > continue_button.top and mouse_pos[1] < continue_button.bottom:
                            paused = False
            ...
            if game_state == "exploring":
                ...
                if paused == True:
                    if saving == True:
                        if mouse_pos[0] < file1_button.right and mouse_pos[0] > file1_button.left and mouse_pos[1] > file1_button.top and mouse_pos[1] < file1_button.bottom:
                            feedback = "saving..."
                            save(game_data, "file1", "file1")
                            file1 = load("file3", "file3")
                            if file1 == None:
                                file1 = {"name": "empty"}
                            feedback = "saved succesfully!"
                        if mouse_pos[0] < file2_button.right and mouse_pos[0] > file2_button.left and mouse_pos[1] > file2_button.top and mouse_pos[1] < file2_button.bottom:
                            feedback = "saving..."
                            save(game_data, "file2", "file2")
    ...
    if game_state == "menu":
        ...
        if mouse_pos[0] < dwarf_button.right and mouse_pos[0] > dwarf_button.left and mouse_pos[1] > dwarf_button.top and mouse_pos[1] < dwarf_button.bottom:
            dwarf_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), dwarf_button)
        else:
            dwarf_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), dwarf_button)
        ...
        for obstacle in screen_objects.keys():
            if screen_objects[obstacle] == "house":
                new_obstacle_rect = pygame.Rect(obstacle[0] + 250, (obstacle[1] + obstacle[3]) - 100, obstacle[2] // 3, 100)
        ...
        if paused == True:
            if saving == True:
                ...
                screen.blit(text, text_rect)
                text = medium_font.render(f"file 1: {file1['name']}", False, pygame.Color(255, 255, 255))
                file1_button = pygame.Rect(0, 0, 400, 100)
                file1_button.center = (width/2, height/2 - 200)
                if mouse_pos[0] < file1_button.right and mouse_pos[0] > file1_button.left and mouse_pos[1] > file1_button.top and mouse_pos[1] < file1_button.bottom:
                    file1_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), file1_button)
                else:
                    file1_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), file1_button)
                screen.blit(text, (file1_button.x + 100, file1_button.y + 25))
                text = medium_font.render(f"file 2: {file2['name']}", False, pygame.Color(255, 255, 255))
                file2_button = pygame.Rect(0, 0, 400, 100)
                file2_button.center = (width/2, height/2 - 50)
                if mouse_pos[0] < file2_button.right and mouse_pos[0] > file2_button.left and mouse_pos[1] > file2_button.top and mouse_pos[1] < file2_button.bottom:
                    file2_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), file2_button)
                else:
                    file2_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), file2_button)
                screen.blit(text, (file2_button.x + 150, file2_button.y + 25))
                text = medium_font.render(f"file 3: {file3['name']}", False, pygame.Color(255, 255, 255))
                file3_button = pygame.Rect(0, 0, 400, 100)
                file3_button.center = (width/2, height/2 + 100)
                if mouse_pos[0] < file3_button.right and mouse_pos[0] > file3_button.left and mouse_pos[1] > file3_button.top and mouse_pos[1] < file3_button.bottom:
                    file3_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), file3_button)
                else:
                    file3_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), file3_button)
                screen.blit(text, (file3_button.x + 150, file3_button.y + 25))
                text = medium_font.render("back", False, pygame.Color(255, 255, 255))
                back_button = text.get_rect()
                back_button.center = (50, height - 75)
                back_button.width += 50
                ...
                file1_button = pygame.Rect(0, 0, 400, 100)
                file1_button.center = (width/2, height/2 - 200)
                if mouse_pos[0] < file1_button.right and mouse_pos[0] > file1_button.left and mouse_pos[1] > file1_button.top and mouse_pos[1] < file1_button.bottom and file1["name"] != "empty":
                    file1_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), file1_button)
                else:
                    file1_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), file1_button)
                screen.blit(text, (continue_button.x + 100, file1_button.y + 25))
                text = medium_font.render(f"file 2: {file2['name']}", False, pygame.Color(255, 255, 255))
                file2_button = pygame.Rect(0, 0, 400, 100)
                file2_button.center = (width/2, height/2 - 50)
                if mouse_pos[0] < file2_button.right and mouse_pos[0] > file2_button.left and mouse_pos[1] > file2_button.top and mouse_pos[1] < file2_button.bottom and file2["name"] != "empty":
                    file2_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), file2_button)
                else:
                    file2_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), file2_button)
                screen.blit(text, (file2_button.x + 150, file2_button.y + 25))
                ...
                file3_button = pygame.Rect(0, 0, 400, 100)
                file3_button.center = (width/2, height/2 + 100)
                if mouse_pos[0] < file3_button.right and mouse_pos[0] > file3_button.left and mouse_pos[1] > file3_button.top and mouse_pos[1] < file3_button.bottom and file3["name"] != "empty":
                    file3_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), file3_button)
                else:
                    file3_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), file3_button)
                screen.blit(text, (file3_button.x + 150, file3_button.y + 25))
                ...
                text_rect.center = (width/2, height/2 - 350)
                screen.blit(text, text_rect)
                text = big_font.render("continue", False, pygame.Color(255, 255, 255))
                continue_button = pygame.Rect(0, 0, 400, 100)
                continue_button.center = (width/2, height/2 - 200)
                if mouse_pos[0] < continue_button.right and mouse_pos[0] > continue_button.left and mouse_pos[1] > continue_button.top and mouse_pos[1] < continue_button.bottom:
                    continue_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), continue_button)
                else:
                    continue_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), continue_button)
                screen.blit(text, (continue_button.x + 100, continue_button.y + 25))
                text = big_font.render("save", False, pygame.Color(255, 255, 255))
                save_button = pygame.Rect(0, 0, 400, 100)
                save_button.center = (width/2, height/2 - 50)
                if mouse_pos[0] < save_button.right and mouse_pos[0] > save_button.left and mouse_pos[1] > save_button.top and mouse_pos[1] < save_button.bottom:
                    save_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), save_button)
                else:
                    save_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), save_button)
                screen.blit(text, (save_button.x + 150, save_button.y + 25))
                text = big_font.render("load", False, pygame.Color(255, 255, 255))
                load_button = pygame.Rect(0, 0, 400, 100)
                load_button.center = (width/2, height/2 + 100)
                if mouse_pos[0] < load_button.right and mouse_pos[0] > load_button.left and mouse_pos[1] > load_button.top and mouse_pos[1] < load_button.bottom:
                    exit_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), load_button)
                else:
                    exit_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), load_button)
                screen.blit(text, (load_button.x + 150, load_button.y + 25))
                text = big_font.render("exit", False, pygame.Color(255, 255, 255))
                exit_button = pygame.Rect(0, 0, 400, 100)
                exit_button.center = (width/2, height/2 + 250)
                if mouse_pos[0] < exit_button.right and mouse_pos[0] > exit_button.left and mouse_pos[1] > exit_button.top and mouse_pos[1] < exit_button.bottom:
                    exit_button = pygame.draw.rect(screen, pygame.Color(150, 150, 150), exit_button)
                else:
                    exit_button = pygame.draw.rect(screen, pygame.Color(180, 180, 180), exit_button)
                screen.blit(text, (exit_button.x + 150, exit_button.y + 25))
...
def reset():
    global game_state, feedback, user_input, border, paused, player_imagex, player_imagey, collision, saving, loading
    game_state = "menu"
    feedback = ""
    user_input = ""
    paused = False
    ...
    if game_state == "menu":
        ...
        if paused == False:
            if keys[K_w] == True:
                ...
                for obstacle in current_map.keys():
                    obstacle_rect = pygame.Rect(obstacle)
                    if player_rect.top >= (obstacle_rect.bottom - worldy + (height/2)) and player_rect.right > obstacle_rect.left - worldx + (width/2) and player_rect.left < obstacle_rect.right - worldx + (width/2):
                        worldy -= 11
                        collision = True
                if keys[K_a] == False and keys[K_s] == False and keys[K_d] == False and collision == False:
                    worldy += 5
            if keys[K_a] == True:
                ...
                for obstacle in current_map.keys():
                    obstacle_rect = pygame.Rect(obstacle)
                    if player_rect.left >= (obstacle_rect.right - worldx + (width/2)) and player_rect.bottom > obstacle_rect.top - worldy + (height/2) and player_rect.top < obstacle_rect.bottom - worldy + (height/2):
                        worldx -= 11
                        collision = True
                if keys[K_w] == False and keys[K_s] == False and keys[K_d] == False and collision == False:
                    worldx += 5
            if keys[K_s] == True:
                ...
                for obstacle in current_map.keys():
                    obstacle_rect = pygame.Rect(obstacle)
                    if ((player_rect.bottom >= obstacle_rect.top - worldy + (height/2) and current_map[obstacle] == "wall") or (player_rect.top >= (obstacle_rect.top - worldy + height/2) and current_map[obstacle] != "wall")) and player_rect.right > obstacle_rect.left - worldx + (width/2) and player_rect.left < obstacle_rect.right - worldx + (width/2):
                        worldy += 11
                        collision = True
                if keys[K_a] == False and keys[K_w] == False and keys[K_d] == False and collision == False:
                    worldy -= 5
            if keys[K_d] == True:
                ...
                for obstacle in current_map.keys():
                    obstacle_rect = pygame.Rect(obstacle)
                    if player_rect.right >= (obstacle_rect.left - worldx + (width/2)) and player_rect.bottom > obstacle_rect.top - worldy + (height/2) and player_rect.top < obstacle_rect.bottom - worldy + (height/2):
                        worldx += 11
                        collision = True
            if keys[K_w] == False and keys[K_a] == False and keys[K_s] == False and keys[K_d] == False:
                player_imagex = 0
